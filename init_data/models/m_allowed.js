...
let oneToMany = function (valueOne, valuesMany) {
    Promise.all(promiseHelper.getManyFindModel(M_Allowed_Contraindications, valuesMany)).then(contraindications => {
                    ...
                    M_Allowed.create(
                        {
                            ...
                            contraindications: promiseHelper.joinAllResults(contraindications)
                        },
                        err => {
                            if (err) throw err
                        }
